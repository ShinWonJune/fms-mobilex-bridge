...
"""
docker run 예시:
  docker run --name fms-temphum \ # 컨테이너 이름
    --es-url {Google Slide} \ # API endpoint
...
"""
"""
            "kafka_docker_temphum.py",
            "--es-url",
            "http://10.20.2.21:59200",
            "--index-pattern",
            "perfhist-fms*",
            "--kafka-brokers",
            "10.79.1.1:9094",
            ...
            "60",
            "--checkpoint-file",
            "checkpoint_filter.json",
            "--fields",
            "TEMPERATURE,HUMIDITY,TEMPERATURE1,HUMIDITY1,objId,rsctypeId"
"""
import os
import json
import time
